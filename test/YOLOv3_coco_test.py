...
# base_anchors = np.array(base_anchors, np.float32)
# base_anchors = base_anchors.reshape(3, 3, 2)
# base_anchors = base_anchors[::-1]
...
class YOLOv3():
    ...
    def build_net(self):
        ...
        # self.im_input = tf.placeholder(dtype=tf.float32,shape=[None,None,3])
    ...
    #     self.build_net()
    #
    #     file = '/home/zhai/PycharmProjects/Demo35/yolo/yolo_last_m_gpu/models/yolov3_voc_train_74_last_same_dist_m_gpu.ckpt-999'
    #     # file = '/home/zhai/PycharmProjects/Demo35/yolo/yolo_last/models/yolov3_voc_train_74_last_same_dist.ckpt-4999'
    #     file = '/home/zhai/PycharmProjects/Demo35/yolo/yolov3_last/models/yolov3_voc_4.ckpt-15000'
    #
...
if __name__ == "__main__":
    ...
    weightsfile = '/home/zhai/PycharmProjects/Demo35/yolo/yolo_weights/yolov3.weights'

    config = Config(files, cfgfile, weightsfile, num_cls=80, img_size=544, ignore_thresh=0.5)
