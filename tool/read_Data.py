...
def parse(se):
    ...
    #
    # # img, bboxes = tf.py_func(crop_img, [img, bboxes], [tf.float32, tf.float32], name='jitter')
...
if __name__ == "__main__":
    ...
    config = Config(files,jitter_ratio=[0.3,0.5,0.7],crop_iou=0.45)
